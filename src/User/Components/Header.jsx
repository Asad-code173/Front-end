  ...
  return (
    <header className='bg-white w-full h-16 sticky top-0 shadow-md flex items-center justify-end px-4 sm:px-6 lg:px-10 gap-4 '>
      ...
      <div className='flex flex-1 justify-center'>
        ...
        <div className="hidden sm:flex items-center sm:ml-44 lg:ml-32 xl:ml-44 border border-gray-300 rounded-2xl overflow-hidden">
      ...
      <span className='profile flex items-center gap-3 sm:gap-4'>
        ...
        <span className='profile-name flex flex-col leading-tight'>
          <span className='name text-sm sm:text-base text-[#111] font-semibold'>{user?.username}</span>
          <span className='role text-xs sm:text-sm text-gray-500'>{user?.role}</span>
        </span>
